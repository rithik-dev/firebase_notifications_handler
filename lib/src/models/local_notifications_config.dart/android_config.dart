...
class AndroidNotificationsConfig {
  AndroidNotificationsConfig({
    ...
    this.channelIdGetter = channelIdGetter ?? (msg) => msg.notification?.android?.channelId ?? defaultChannelId;
    ...
    this.smallIconUrlGetter = smallIconUrlGetter ?? (msg) => msg.notification?.android?.smallIcon ?? defaultSmallIcon;
  ...
  ///
  /// {@endtemplate}
  static String defaultChannelDescription = 'Default channel for all notifications';
