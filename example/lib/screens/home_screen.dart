  ...
  void initState() {
    ...
    FirebaseNotificationsHandler.createAndroidNotificationChannels([
      ...
      AndroidNotificationChannel(
        AndroidNotificationsConfig.defaultChannelId,
        AndroidNotificationsConfig.defaultChannelName,
        description: AndroidNotificationsConfig.defaultChannelDescription,
    ...
    _notificationTapsSubscription = FirebaseNotificationsHandler.notificationTapsSubscription.listen(
      _addNotificationTap,
    );

    _notificationArriveSubscription = FirebaseNotificationsHandler.notificationArrivesSubscription.listen(
      _addNotificationArrive,
    );
  }
